    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-1">
                <form class="form-horizontal" action="terrarium_tmp.php" method="POST">
                    <div class="form-group">
                        <label for="dimension" class="col-sm-6 form-control-label">Dimension:</label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="dimension" placeholder="dimension" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="startNrCarnivore" class="col-sm-6 form-control-label">Start amount carnivores: </label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="startNrCarnivore" placeholder="Start amount carnivores">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="startNrPlants" class="col-sm-6 form-control-label">Start amount plants: </label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="startNrPlants" placeholder="Start amount plants">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="startNrHerbivore" class="col-sm-6 form-control-label">Start amount herbivores: </label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="startNrHerbivore" placeholder="Start amount herbivores">
                        </div>
                    </div>
